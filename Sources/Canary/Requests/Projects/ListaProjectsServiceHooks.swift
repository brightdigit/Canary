...
public extension Projects {
  ...
  enum ListaProjectsServiceHooks {
    public static let service = Service<Response>(id: "List a Project's Service Hooks", tag: "Projects", method: "GET", path: "/api/0/projects/{organization_slug}/{project_slug}/hooks/", hasBody: false, securityRequirements: [SecurityRequirement(type: "auth_token", scopes: ["project:read"])])

    public struct Request: ServiceRequest {
      public typealias ResponseType = Response

      public var service: Service<Response> {
        ListaProjectsServiceHooks.service
      }
