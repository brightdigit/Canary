...
extension Organizations {
    ...
    public enum ListaRepositorysCommits {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "organization_slug" + "}", with: "\(self.options.organizationSlug)").replacingOccurrences(of: "{" + "repo_id" + "}", with: "\(self.options.repoId)")
            }
        }
