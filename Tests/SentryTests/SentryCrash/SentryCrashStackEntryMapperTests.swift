...
class SentryCrashStackEntryMapperTests: XCTestCase {
  ...
  func testIsInApp() {
    let frame = getFrameWithImageName(imageName: "/private/var/containers/Bundle/Application/03D20FB6-852C-4DD3-B69C-3231FB41C2B1/iOS-Swift.app/\(bundleExecutable)")
