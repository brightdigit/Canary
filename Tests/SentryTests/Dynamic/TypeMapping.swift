...
class TypeMapping {
  ...
  static func convertToObjCType(_ object: Any?) -> Any? {
    switch object {
    case is [Any]: return object as? NSArray
    ...
    case is [AnyHashable: Any]: return object as? NSDictionary
  ...
  static func convertToSwiftType(_ object: Any?) -> Any? {
    switch object {
    case is NSArray: return object as? [Any]
    ...
    case is NSDictionary: return object as? [AnyHashable: Any]
