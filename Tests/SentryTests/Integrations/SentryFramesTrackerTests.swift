  ...
  class SentryFramesTrackerTests: XCTestCase {
    private class Fixture {
      ...
      var sut: SentryFramesTracker {
        SentryFramesTracker(displayLinkWrapper: displayLinkWrapper)
      }
    }
    ...
    func testAllFrames_ConcurrentRead() {
      ...
      assertPreviousCountBiggerThanCurrent(group) { currentFrames.frozen }
      assertPreviousCountBiggerThanCurrent(group) { currentFrames.slow }
      assertPreviousCountBiggerThanCurrent(group) { currentFrames.total }
