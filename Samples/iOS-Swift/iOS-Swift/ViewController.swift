...
class ViewController: UIViewController {
  @IBOutlet var dsnTextField: UITextField!
  ...
  @IBAction func addBreadcrumb(_: Any) {
  ...
  @IBAction func captureMessage(_: Any) {
  ...
  @IBAction func captureUserFeedback(_: Any) {
  ...
  @IBAction func captureError(_: Any) {
    do {
  ...
  @IBAction func captureNSException(_: Any) {
  ...
  @IBAction func captureTransaction(_: Any) {
  ...
  @IBAction func asyncCrash(_: Any) {
    DispatchQueue.main.async {
      self.asyncCrash1()
    }
  }
  ...
  @IBAction func resetDSN(_: Any) {
    dsnTextField.text = AppDelegate.defaultDSN
    dsnTextField.backgroundColor = UIColor.systemGreen
  ...
  @IBAction func showNibController(_: Any) {
